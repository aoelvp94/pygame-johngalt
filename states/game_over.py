...
from constants import SAD_PEDRO_SHEET
...
class GameOver(BaseState):
    ...
    def draw(self, surface):
        ...
        sheet = pygame.image.load(SAD_PEDRO_SHEET).convert_alpha()
        sheet.set_colorkey(-1, pygame.RLEACCEL)
        rect = pygame.Rect([0, 200, 300, 524])
